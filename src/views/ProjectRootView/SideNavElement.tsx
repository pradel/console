    ...
    return (
      <Link to={link} onClick={onClick} title={text} {...rest}>
        ...
        >
          <style jsx>{`
            .side-nav-element {
              @p: .relative, .flex, .itemsCenter, .w100, .fw6, .f14, .ttu,
                .white, .mt12, .o60;
            ...
            .side-nav-element.active,
            .side-nav-element:hover {
              @p: .o100;
            }
            .side-nav-element.active:not(.minimalHighlight),
            .side-nav-element:not(.minimalHighlight):hover {
              @p: .bgWhite07;
            }
